...
class RaftServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.AppendEntries = channel.unary_unary(
                ...
                _registered_method=True)
        # ClientAppend: leader-only RPC for client commands (uses AppendEntriesRequest/Response)
        self.ClientAppend = channel.unary_unary(
                '/raft.RaftService/ClientAppend',
                request_serializer=raft__pb2.AppendEntriesRequest.SerializeToString,
                response_deserializer=raft__pb2.AppendEntriesResponse.FromString,
                _registered_method=True)
        self.Disconnect = channel.unary_unary(
                '/raft.RaftService/Disconnect',
...
def add_RaftServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            # ClientAppend is a leader-only RPC that uses AppendEntriesRequest/Response
